...
class Manager {
public:
    CHIRP_API Manager(asio::ip::address brd_address, asio::ip::address any_address, std::string_view group, std::string_view host);
    CHIRP_API Manager(std::string_view brd_ip, std::string_view any_ip, std::string_view group, std::string_view host);
